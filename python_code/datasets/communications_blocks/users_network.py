...
NUMBER_OF_USERS_DICT = {
    Phase.TRAIN: {(i, j): user for i, j, user in zip(list(range(0, TRAINING_BLOCKS_PER_CONFIG * MAX_USERS, TRAINING_BLOCKS_PER_CONFIG)),
                                                     list(range(TRAINING_BLOCKS_PER_CONFIG, TRAINING_BLOCKS_PER_CONFIG * (MAX_USERS + 1),
                                                                TRAINING_BLOCKS_PER_CONFIG)),
                                                     range(2, MAX_USERS + 1))},
    Phase.TEST: {(0, 20): 18, (20, 40): 19, (40, 60): 20, (60, 80): 21, (80, 100): 22}}
