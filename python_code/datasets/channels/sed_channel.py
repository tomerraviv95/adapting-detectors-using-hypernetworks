...
COEF = 16 / 4
TRAIN_SNR_PER_USER = [
    (TRAIN_SNR, COEF * TRAIN_SNR, 50), (TRAIN_SNR, COEF * TRAIN_SNR, 50),
    (TRAIN_SNR, COEF * TRAIN_SNR, 50), (TRAIN_SNR, COEF * TRAIN_SNR, 50),
    (TRAIN_SNR, COEF * TRAIN_SNR, 50), (TRAIN_SNR, COEF * TRAIN_SNR, 50),
    (TRAIN_SNR, COEF * TRAIN_SNR, 50), (TRAIN_SNR, COEF * TRAIN_SNR, 50),
    (TRAIN_SNR, COEF * TRAIN_SNR, 50), (TRAIN_SNR, COEF * TRAIN_SNR, 50),
...
COEF = 12 / 10
TEST_SNR_PER_USER = [
    (TEST_SNR, COEF * TEST_SNR, 10), (TEST_SNR, COEF * TEST_SNR, 20),
    (TEST_SNR, COEF * TEST_SNR, 30), (TEST_SNR, COEF * TEST_SNR, 40),
    (TEST_SNR, COEF * TEST_SNR, 50), (TEST_SNR, COEF * TEST_SNR, 60),
    (TEST_SNR, COEF * TEST_SNR, 70), (TEST_SNR, COEF * TEST_SNR, 80),
    (TEST_SNR, COEF * TEST_SNR, 90), (TEST_SNR, COEF * TEST_SNR, 100),
    (TEST_SNR, COEF * TEST_SNR, 110), (TEST_SNR, COEF * TEST_SNR, 120),
    (TEST_SNR, COEF * TEST_SNR, 130), (TEST_SNR, COEF * TEST_SNR, 140),
    (TEST_SNR, COEF * TEST_SNR, 150), (TEST_SNR, COEF * TEST_SNR, 160),
    (TEST_SNR, COEF * TEST_SNR, 10), (TEST_SNR, COEF * TEST_SNR, 20),
    (TEST_SNR, COEF * TEST_SNR, 30), (TEST_SNR, COEF * TEST_SNR, 40),
    (TEST_SNR, COEF * TEST_SNR, 50), (TEST_SNR, COEF * TEST_SNR, 60),
    (TEST_SNR, COEF * TEST_SNR, 70), (TEST_SNR, COEF * TEST_SNR, 80),
