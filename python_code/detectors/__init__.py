from python_code.detectors.hypernetwork_deepsic.hypernetwork_deepsic_trainer import OnlineHypernetworkDeepSICTrainer
...
DETECTORS_TYPE_DICT = {DetectorType.seq_deepsic.name: SeqDeepSICTrainer,
                       ...
                       DetectorType.online_hyper_deepsic.name: OnlineHypernetworkDeepSICTrainer}
