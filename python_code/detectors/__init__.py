...
from python_code.detectors.rnn_hypernetwork_deepsic.rnn_hypernetwork_deepsic_trainer import RNNHypernetworkTrainer
...
DETECTORS_TYPE_DICT = {DetectorType.online_deepsic.name: OnlineDeepSICTrainer,
                       ...
                       DetectorType.rnn_hyper_deepsic.name: RNNHypernetworkTrainer}
